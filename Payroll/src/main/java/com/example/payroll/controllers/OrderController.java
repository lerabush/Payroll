...
import com.example.payroll.assemblers.OrderModelAssembler;
...
public class OrderController {
    ...
    ResponseEntity<EntityModel<Order>> newOrder(@RequestBody Order order){
        ...
        return ResponseEntity.created(linkTo(methodOn(OrderController.class)
                .findOne(newOrder.getId())).toUri()).body(assembler.toModel(newOrder));
    }
    ...
    public ResponseEntity<?> complete(@PathVariable Long id){
        ...
        return ResponseEntity.status(HttpStatus.METHOD_NOT_ALLOWED)
                .header(HttpHeaders.CONTENT_TYPE, MediaTypes.HTTP_PROBLEM_DETAILS_JSON_VALUE).body(Problem.create()
    ...
    public ResponseEntity<?> cancel(@PathVariable Long id){
        ...
        return ResponseEntity
                ...
                .header(HttpHeaders.CONTENT_TYPE,MediaTypes.HTTP_PROBLEM_DETAILS_JSON_VALUE).body(Problem.create()
                        .withTitle("Method not allowed")
                .withDetail("Yo can't cancel an order which have status "+order.getStatus()));
    }
